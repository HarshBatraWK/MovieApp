...
namespace WebApplication1.Controllers
{
    ...
    public class ViewingHistoriesController : ControllerBase
    {
        ...
        {
            return await _context.ViewingHistories.ToListAsync();
        }
        ...
        public async Task<ActionResult<ViewingHistory>> PostViewingHistory(ViewingHistory viewingHistory)
        {
            ...
            return CreatedAtAction("GetViewingHistory", new { id = viewingHistory.Id }, viewingHistory);
        }
        ...
        {
            return _context.ViewingHistories.Any(e => e.Id == id);
        }
    }
}
